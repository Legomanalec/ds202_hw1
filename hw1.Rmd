...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Alec Meyer** and I am a *Software Engineer* pursuing a minor in Data Science. I enjoy machine learning and hope to apply that field in my career. I play guitar in a band consisting of ISU professors in my free time.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job I believe would be related to Data Science would be a Computer Vision and Machine Learning Engineer. An example of this position would be this [Link](https://www.google.com/search?safe=strict&sxsrf=ALeKk02Kt94N3213Lsf1jf9UERMTo-HiVA:1598216017210&ei=UddCX9e4DImttQarr5zIAw&q=machine+learning+engineer+jobs&oq=machine+learning+engineer+j&gs_lcp=CgZwc3ktYWIQARgAMgcIABAUEIcCMgIIADICCAAyAggAMgIIADICCAAyAggAMgIIADICCAAyAggAOgQIABBHOgQIABBDUKUSWP0dYLwiaABwAXgAgAFEiAF_kgEBMpgBAKABAaoBB2d3cy13aXrAAQE&sclient=psy-ab&ibp=htl;jobs&sa=X&ved=2ahUKEwiN-7PSmrLrAhXMGs0KHWAGBusQp4wCMAB6BAgMEAE#fpstate=tldetail&htivrt=jobs&htiq=machine+learning+engineer+jobs&htidocid=egVMf3ugVvUVl9uEAAAAAA%3D%3D) ![](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSj_teU4syILTVPk9uBiBrecm3EYIMaotTSrzIb&s=0) 
  
5. What data topic will you be most interested in? (Optional) Provide a source of such data set if you have.

    Answer: In this climate I would love to see and understand the spread of Covid-19 using [this](https://covid19.who.int/?gclid=Cj0KCQjwp4j6BRCRARIsAGq4yMG6SGQ4FIMGuxURKzyPSwvmdKRhILEsg6RqV483rBeerEFoXM5LWYcaAlYEEALw_wcB) website.
  
6. To check that your R and Rstudio installation is correct, find the version of R by entering `version` into the R console. Include this command into a R code chunk in your solution `Rmd` file to have it automatically print in the knitted html file. 

    Answer: version report:
```{r echo=FALSE}
    version
```
